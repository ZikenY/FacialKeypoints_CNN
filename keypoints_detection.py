...
def nn_model(x, y_, keep_prob):
    ...
    # init conv layer. 64 kernels with size of 2x2
    W_conv2 = init_W([2, 2, 32, 64])
    b_conv2 = init_bias([64])
    # convolute, relu. output shape: ? x 46x46 x 64
    ...
    # init fc_layer. (11x11x128) to 500
    W_fc1 = init_W([11 * 11 * 128, 500])
    b_fc1 = init_bias([500])
    ...
    # init fc_layer. 500 neurons
    W_fc2 = init_W([500, 500])
    b_fc2 = init_bias([500])
    # ?x500 -> ?x500
